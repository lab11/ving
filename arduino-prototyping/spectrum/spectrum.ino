...
const int FFT_SIZE = 256;              //256 Size of the FFT.  Realistically can only be at most 256 
...
void loop() {
  ...
  if (samplingIsDone()) {
    ...
    //arm_cfft_radix4_init_q31(&fft_inst, samples, 0, 1);
    int status = arm_cfft_radix4_init_q31(&fft_inst_fix, FFT_SIZE, 0, 1);
    ...
    for (int i = 0; i < FFT_SIZE; ++i) {
     ...
     // magnitudes[i] = (float)(magnitudes_fix[i] >> 15);
    }
    /////////////////////////////////////////////////////////////////////////////////
...
void samplingCallback() {
  ...
  samples_fix[sampleCounter] = (q31_t)(analogRead(AUDIO_INPUT_PIN) << (31-10));
